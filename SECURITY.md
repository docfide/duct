...
Currently, only the latest release of Duct is actively supported with security updates. 
Please ensure you are running the latest version from `npm` or the `main` branch.
